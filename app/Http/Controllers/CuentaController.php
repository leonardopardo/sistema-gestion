...
class CuentaController extends Controller
{
    ...
    public function store(CuentaStoreRequest $request)
    {
        ...
        try {
            ...
            flash(MSG_SUCCESS . "La cuenta <strong>{$cuenta->razon_social}</strong> se creó correctamente.")
                ->success()
                ->important();
    ...
    public function update(CuentaUpdateRequest $request, Cuenta $cuenta)
    {
        ...
        try {
            ...
            flash(MSG_SUCCESS . "La cuenta <strong>{$cuenta->razon_social}</strong> se actualizadó correctamente.")
                ->success()
                ->important();
    ...
    public function destroy(Cuenta $cuenta)
    {
        ...
        try {
            ...
            flash(MSG_SUCCESS . "La cuenta <strong>{$nombre}</strong> se eliminó correctamente.")
                ->success()
                ->important();
